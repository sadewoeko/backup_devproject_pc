      ...
      <div class="container">
        <div class="product-details">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="about-product">
                ...
                <div class="item-price" style="margin:0">
                  <div class="current-price"><span class="currency">{{ $data->currency }} </span><span class="price">{{ $data->product_price }}</span></div>
                </div>
              ...
              @endif
                <div class="product-meta" style="margin-top:15px">
                  <span class="meta-id">Product ID : <span class="meta-about">{{ $data->id }}</span></span>
                  ...
                  <span class="meta-id">Payment : <span class="meta-about">{{ $data->payment }}</a></span></span>
                  <span class="meta-id">Packaging : <span class="meta-about">{{ $data->packaging }}</a></span></span>
                  <span class="meta-id">Delivery : <span class="meta-about">{{ $data->delivery }}</a></span></span>
                </div>
              </div><!-- /.about-product -->
            </div>
          </div>
          ...
          <div class="product-tabs" style="margin-top:20px">
            @if (empty(session('full_name')))
              <h4 class="alert alert-danger">Sorry! You need <a href="{{ route('auth.sign-in') }}">sign in</a> to see more details and contact information</h4>
            @else
            <div class="tabs">
              <div role="tabpanel">
                ...
                <div class="tab-content" style="background-color:#fff;padding:2px;height:auto">
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="tab2">
                    <p class="description">
                    <div class="panel panel-info" style="margin:0;border-color:aliceblue">
                      <div class="panel-heading" style="height:42">
                        <div class="col-md-6">
                          ...
                          <div class=" col-md-9 col-lg-9 "> 
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="col-sm-5">
                                  <strong for="Company">Company Name</strong>
                                </div>
                                ...
                                <div class="col-sm-5">
                                  <strong for="Company">Address</strong>
                                </div>
                                <div class="col-sm-6">
