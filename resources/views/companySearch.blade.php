...
<section class="shop-contents">
    <div class="section">
      <div class="container">
        <div class="row">
        <h2><center>--COMPANY SHOW--</center></h2>
                ...
                <div role="tabpanel" class="tab-pane fade active in text-left" id="list">
                      <div class="item media">
                        ...
                        <div class="item-content media-body">
                          <h2 class="item-title">
                            <div class="company"><span class="company">{{ link_to_route('profile.index', $data->company_name, array($data->id), array('class' => 'green')) }}</span>
                            </div>
                          </h2><!-- /.item-title -->
